    ...
    <div className={classes.hero}>
      <div className={classes.leftHero}>
        <div className={classes.upper}>
          ...
          <h1 className={classes.name}>Aniket kamble</h1>
        ...
        <div className={classes.lower}>
          ...
          <div className={classes.gitlink}>
            ...
            <div className={classes.link}>
              ...
              <div className={classes.rest}>github.com/Aniket-1295</div>
              <div className={classes.rest2}>github.com/Aniket-1295/PortFolio</div>
